...
fit.causali = susie_rss(z=XtyZ,R=XtX,n=Nvec[1],L=L.causal,estimate_prior_method="optim",s_init=fit.causal,prior_weights=prior_weights,intercept=F,max_iter=10)
